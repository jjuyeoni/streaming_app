...
public class JoinActivity extends AppCompatActivity {
    ...
    private final static String REGISTER_API_ENDPOINT_URL = "https://avocadoapi.herokuapp.com/api/v1/registrations";
    ...
    public void registerNewAccount(View button) {
        ...
        EditText userPasswordField = (EditText) findViewById(R.id.userPwd);
        mUserPassword = userPasswordField.getText().toString();
        EditText userPasswordConfirmationField = (EditText) findViewById(R.id.userPwdConfirm);
        ...
        if (mUserEmail.length() == 0 || mUserPassword.length() == 0 || mUserPasswordConfirmation.length() == 0) {
            ...
            if (!mUserPassword.equals(mUserPasswordConfirmation)) {
                ...
                // everything is ok!
                RegisterTask registerTask = new RegisterTask(JoinActivity.this);
